...
import { getRestaurantMenu } from "../../services/restaurantApi";
    ...
    return (
        ...
        <div className="w-[50%] mx-auto flex flex-wrap text-black">
            ...
            <div className="w-full mt-10 flex gap-4">
                <button
                    className={`text-black border p-1 border-gray-300 rounded-2xl w-20 hover:cursor-pointer ${selected=='veg'?'bg-green-400':'bg-white'}`}
                ...
                <button
                    className={`text-black border p-1 border-gray-300 rounded-2xl w-20 hover:cursor-pointer ${selected=='nonveg'?'bg-red-400':"bg-white"}`}
            ...
            <div className='w-full mt-7 mb-3 text-gray-300'>
                <hr />
            </div>
